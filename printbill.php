...
$sql0 = "SELECT r.rent_id, r.rent_end_date, r.rent_start_date, o.car_name, o.car_number FROM rent r, owners o WHERE rent_id = '$rent_id' AND o.car_id = r.car_id";
...
if ($result1){
     $sql2 = "UPDATE owners o, rente r SET o.car_availability='yes',
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                ?>
                <h4> <strong>Total Fine:</strong> <label class="text-danger"> K<?php echo $total_fine; ?>/- </label> for <?php echo $extra_days;?> extra days.</h4>
                <br>
                <?php } ?>
