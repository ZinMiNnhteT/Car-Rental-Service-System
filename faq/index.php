    ...
    <nav class="navbar navbar-custom" role="navigation" style="color: black">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll"style="font-size: 30px;font: weight 600px;" href="/../car/index.php">
            ...
            ?>
                        ...
                        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                            <ul class="nav navbar-nav">
                                <li>
                                    <a href="/../car/index.php">Home</a>
                                </li>
                                <li>
                                    <a href="/../car/clientlogin.php">Admin</a>
                                </li>
                                <li>
                                    <a href="/../car/customerlogin.php">User</a>
                                </li>
                                <li>
