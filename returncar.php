...
//  FROM rentedcars rc, cars c, driver d
 $sql1 = "SELECT owners.car_name, owners.car_number, rent.rent_start_date, rent.rent_end_date, rent.fee FROM rent, owners
 
 WHERE rent_id = '$rent_id' AND owners.car_id=rent.car_id";
...
?>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        <form role="form" action="printbill.php?id=<?php echo $rent_id ?>" method="POST">
        <br style="clear: both">
          ...
          <input type="hidden" name="hid_fare" value="<?php echo $fee; ?>">
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© Online Car Rental Service System</h5>
                </div>
            </div>
        </div>
    </footer>
