...
<?php $login_client = $_SESSION['login_client']; 
    ...
    $sql1 = "SELECT * FROM rent r,carregisters cr, users u, owners WHERE cr.admin_id = '$login_client' AND cr.car_id = r.car_id AND r.return_status = 'R' AND u.user_name = r.user_id AND cr.car_id = owners.car_id";
