...
$query = "INSERT into users(user_name,user_id,user_email,user_phone,user_address,user_password) VALUES('" . $user_name . "','" . $user_id . "','" . $user_email . "','" . $user_phone . "','" . $user_address ."','" . $user_password ."')";
