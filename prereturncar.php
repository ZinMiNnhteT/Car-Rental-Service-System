...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT c.car_name, rc.rent_start_date, rc.rent_end_date, rc.fee, rc.charge_type, rc.rent_id FROM rent rc, owners c
    WHERE rc.user_id='$login_customer' AND c.car_id=rc.car_id AND rc.return_status='NR'";
...
<div class="container">
      <div class="jumbotron">
        <h1>The car must be deposited here</h1>
...
?></td>
<td><a href="returncar.php?id=<?php echo $row["rent_id"];?>"> Return </a></td>
</tr>
<?php        } ?>
                </table>
                </div> 
        <?php } else {
            ...
            <div class="container">
      <div class="jumbotron">
        <h1>No cars return.</h1>
        <p> Hope you enjoyed car rental service </p>
      </div>
    </div>
